...
def pmv(ta, tr, va, rh, met, clo, wmet=0):
    ...
    hcf = 12.1 * va**0.5  # forced convective heat transfer coefficient

    hc = hcf  # initial convective heat transfer coefficient
    ...
    for i in range(100):
        ...
        hcn = 2.38 * abs(tcl - ta)**0.25  # natural convective heat transfer coefficient
