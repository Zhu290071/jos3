...
ALL_OUT_PARAMS = {
    ...
    'Ret': {'ex_output': True,
            ...
            'suffix': 'Body name',
            'unit': 'Pa·m2/W'},
    'RetAirBoundary': {'ex_output': True,
                       'meaning': 'Evaporative resistance of the boundary air layer',
                       'suffix': 'Body name',
                       'unit': 'Pa·m2/W'},
    'RetClothing': {'ex_output': True,
                    'meaning': 'Intrinsic clothing evaporative resistance of the body part',
                    'suffix': 'Body name',
                    'unit': 'Pa·m2/W'},
    'RetFcl': {'ex_output': True,
               'meaning': 'Clothing area factor used for evaporative calculations',
               'suffix': 'Body name',
               'unit': '-'},
